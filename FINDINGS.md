...
27. **The Deck Optimisation Engine page predates the split.** Its repo was marked superseded on 2026-09-11 and points at archetype-tracking, and the page's "Tracks movement, not presence" bullet describes the tracking half that moved. The page reads as current. Whether it should carry a superseded line pointing at /projects/archetype-tracking/ is an owner call, since the page was approved in its present shape (DECISIONS 187).

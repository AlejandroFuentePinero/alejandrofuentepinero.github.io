...
permalink: /research/forest-gap-birds-2025/
redirect_from:
  - /publication/siri_2025
excerpt: 'Natural forest gaps reshaped bird assemblages in Thai montane rainforest while total abundance stayed level. Only one gap specialist increased with gap size.'
summary: |
  Natural canopy gaps changed which birds live where in Thai lower montane
  rainforest, while total abundance stayed level. The evidence is 5 years of
  mist-netting at paired gap and closed-canopy sites, 2015 to 2019: 1,148
  captures of 81 species. Assemblage composition shifted strongly with gaps,
  and the long design also captured seasonal turnover driven by migration.

  Most species showed no relationship with gap size. One specialist, the
  Hill Blue Flycatcher, increased in abundance as total gap size grew. Gaps
  of 130 to 1,020 square metres read as moderate disturbance: not highly
  detrimental, yet enough to affect sensitive species. An analysis of
